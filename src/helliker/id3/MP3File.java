 ...
 *  from the mp3 specified by the file.  If there are no helliker.id3 tags present,
...
public class MP3File implements Comparable {
    ...
    /**
     * Do not write or read from any helliker.id3 tags.
     */
     ...
     * and write helliker.id3 tags that already exist in the file.
     *
     ...
     * helliker.id3 tags tha already exist in the file.
     *
    ...
    /**
     * Create an MP3File object that reads and writes to the file with the 
     * filename fn.  The helliker.id3 tags that are read from and written are
     ...
     * The helliker.id3 tags that are read from and written are
     * dependant upon the tagType argument.  This could be either: BOTH_TAGS,
     * ID3V2_ONLY, ID3V1_ONLY, NO_TAGS, or EXISTING_TAGS_ONLY.
     *
     * @param mp3 the file of the mp3
    ...
    /**
     * Removes helliker.id3 tags from the file.  The argument specifies which tags to
    ...
    /**
     * Writes the current state of the helliker.id3 tags to the file.  What tags are
    ...
    /**
     * Returns the track exactly as the track field of the helliker.id3 tag reads.
     *
    ...
    /**
     * Set the tagging type.  This determines what type of helliker.id3 tags are
     ...
     *
     * @param tagVersion the helliker.id3 version to check
     ...
     * information contained within the mpeg header and helliker.id3 tags as well as
